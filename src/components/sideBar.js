	...
	render() {
		...
		const sideList = (
			<div className={classes.list}>
				...
				<List>
					<ListItem button onClick={() => this.props.toggleDialog('skillList')}>
						<ListItemIcon>
							<SkillsIcon />
						</ListItemIcon>
					...
					<ListItem
						button
						onClick={() => openLink(`https://www.linkedin.com/in/wes-corman/`)}
						style={{ paddingLeft: 11 }}
					>
						<ListItemIcon>
							<img style={{ height: 35 }} src={LinkedInLogo} alt="LinkedIn" />
						</ListItemIcon>
					...
					<ListItem button onClick={() => openLink('https://github.com/wcorman')} style={{ paddingLeft: 15 }}>
						<ListItemIcon>
					...
					<ListItem button onClick={() => openLink(`https://500px.com/wcorman`)}>
						<ListItemIcon>
							<CameraIcon />
						</ListItemIcon>
				...
				<Divider />
				<List>
					<ListItem button onClick={() => this.props.toggleDialog('contactForm')}>
						<ListItemIcon>
							<MailIcon />
						</ListItemIcon>
